...
public class AndroidTwitterSample extends Activity {
	...
	final Runnable mUpdateTwitterNotification = new Runnable() {
        ...
        //	Toast.makeText(getBaseContext(), "username is" + TwitterUtils.getUserName(prefs),Toast.LENGTH_LONG).show();
        }
    };
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       loginStatus = (TextView)findViewById(R.id.login_status);
        tweet = (TextView) findViewById(R.id.btn_tweet);
        TextView clearCredentials = (TextView) findViewById(R.id.btn_clear_credentials);
	...
	private String setTweetMsg(){
		return this.tweetMsg.getText().toString();
	}
